...
-- ************************************************************************************************
CREATE UNIQUE INDEX CLASS_ID_IDX
  ON ZOO.CLASSES (ID);
CREATE UNIQUE INDEX FAMILY_ID_IDX
  ON ZOO.FAMILIES (ID);
CREATE INDEX FAMILY_CLASS_ID_IDX
  ON ZOO.FAMILIES (CLASS_ID);
CREATE UNIQUE INDEX SPECIES_ID_IDX
  ON ZOO.SPECIES (ID);
CREATE UNIQUE INDEX SPECIE_FAMILY_ID_IDX
  ON ZOO.SPECIES (ID);
CREATE UNIQUE INDEX ZONE_SPECIES_IDX
  ON ZOO.GEO_ZONE_SPECIES_MAPPING (GEO_ZONE_ID, SPECIES_ID);
CREATE UNIQUE INDEX HOUSES_ID_IDX
  ON ZOO.HOUSES (ID);
CREATE INDEX HOUSES_ZONE_ID_IDX
  ON ZOO.HOUSES (ZOO_ZONE_ID, ID);
CREATE UNIQUE INDEX ANIMALS_ID_IDX
  ON ZOO.ANIMALS (ID);
CREATE INDEX ANIMALS_SPECIES_ID_IDX
  ON ZOO.ANIMALS (SPECIES_ID, ID);
CREATE INDEX ANIMALS_HOUSE_ID_IDX
  ON ZOO.ANIMALS (HOUSE_ID, ID);
CREATE UNIQUE INDEX TASKS_ID_IDX
  ON ZOO.TASKS (ID);
CREATE INDEX TASKS_START_ID_IDX
  ON ZOO.TASKS (STARTED_ACTUAL, STATUS);
CREATE INDEX TASKS_ASSIGNEE_ID_IDX
  ON ZOO.TASKS (ASSIGNEE_ID, ASSIGNER_ID, TASK_TYPE);
CREATE INDEX TASKS_ASSIGNER_ID_IDX
  ON ZOO.TASKS (ASSIGNER_ID, ASSIGNEE_ID, TASK_TYPE);
