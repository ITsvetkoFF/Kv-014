...
CONSTRAINT FK_GEO_ZONE_ID FOREIGN KEY (GEO_ZONE_ID)
      REFERENCES ZOO.GEO_ZONES(ID)
      ON UPDATE CASCADE ON DELETE CASCADE,
...
STARTED_PLANNED TIMESTAMP NOT NULL DEFAULT NOW(),
ACCOMPLISHED_PLANNED TIMESTAMP NOT NULL DEFAULT NOW() + INTERVAL '1 DAY',
STARTED_ACTUAL TIMESTAMP DEFAULT NULL,
ACCOMPLISHED_ACTUAL TIMESTAMP DEFAULT NULL,
ZONE_ID INT NOT NULL,
STATUS VARCHAR(10) DEFAULT 'ASSIGNED', -- ASSIGNED, CANCELED, FINISHED, STARTED, FAILED
...
COMMENT ON COLUMN ZOO.TASKS.STATUS IS 'TASK STATUS (ASSIGNED, CANCELED, FINISHED, STARTED, FAILED)';
--END OF TASKS -------------------------------------------------------------------------------------
...
CREATE INDEX TASKS_STATUS_ID_IDX ON ZOO.TASKS(STATUS);
