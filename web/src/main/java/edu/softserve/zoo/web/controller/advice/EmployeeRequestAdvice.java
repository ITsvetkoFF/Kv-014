package edu.softserve.zoo.web.controller.advice;

import edu.softserve.zoo.core.exceptions.ApplicationException;
import edu.softserve.zoo.core.exceptions.web.WebException;
import edu.softserve.zoo.core.model.Role;
import edu.softserve.zoo.web.controller.rest.EmployeeRestController;
import edu.softserve.zoo.web.dto.EmployeeDto;
import edu.softserve.zoo.web.dto.RoleDto;
...
public class EmployeeRequestAdvice implements RequestBodyAdvice {
    ...
    private RoleDto stringToRoleDto(String role) {
        ...
        try {
            ...
            throw ApplicationException.getBuilderFor(WebException.class).forReason(WebReason.ENUM_MAPPING_FAILED).build();
        }
